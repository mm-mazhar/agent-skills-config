...
### Zip skills with `skill_zipper.ps1`
...
```powershell
powershell -ExecutionPolicy Bypass -File .\skill_zipper.ps1
```

This zips each folder under `.\skills` that contains a `SKILL.md` into `outZips`.